...
const departments = [
  {
    name: "Arauca",
    info: {
      description: "El Departamento del Arauca, se encuentra situado en el extremo nordeste del territorio nacional, en el norte de la región de la Orinoquía colombiana, cuenta con una superficie de 23.818 km2 lo que representa el 2.1 % del territorio nacional. Limita por el Norte con el río Arauca que lo separa de la República de Venezuela, por el Este con la República de Venezuela, por el Sur con los ríos Meta y Casanare, que lo separan del departamento del Vichada y Casanare, y por el Oeste con el departamento de Boyacá.",
      hydrography: "Hidrografía - La mayoría de los ríos araucanos nacen en el piedemonte y la cordillera Oriental, realizando su recorrido en dirección oeste-este. En esa región la precipitación es de 1500 mm, por lo cual es el área más lluviosa del departamento.​ La hidrografía está formada por los ríos Arauca, Casanare, Bojabá, Ele, Lipa, Cravo Norte, San Ignacio o Tame, Tocoragua, Cusay, Satocá, Tigre, Calafita, San Miguel, Capanaparo, Cinaruco, Limón, Banadía y Tocancia. Además hay caños, lagunas y esteros.",
      fauna: "Fauna y flora - En los llanos de Colombia existen un gran número de aves, que desde mitad del siglo XX han sido de interés para grandes investigadores. Unas de las aves más comunes en los alrededores de la ciudad son las garzas. Otro de los muchos animales que se pueden encontrar en la región es el chigüiro, el cual es el roedor más grande del mundo. Tradicionalmente por su cultura ganadera el Caballo es un animal representativo presente en las fincas de la sabana."
    },
    path:
    ...
    color: colorDepartment.orinoquia,
  },
  {
    name: "Casanare",
    info: {
      description: "Casanare es uno de los treinta y dos departamentos que, junto con Bogotá, Distrito Capital, forman la República de Colombia. Su capital es Yopal. Está ubicado en la región Orinoquía, limitando al norte con Arauca, al este con Vichada, al sur con Meta, al oeste con Cundinamarca y al noroeste con Boyacá.",
      hydrography: "La riqueza hidrográfica es una de las principales potencialidades del Departamento de Casanare; abundantes ríos, caños, lagunas y humedales (esteros) forman una intrincada red hídrica que provee a los llaneros de excelente biodiversidad de flora y fauna y les sirve como vía de comunicación y transporte durante la temporada de lluvias.      ",
      fauna: "fauna y flora - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec viverra integer tristique nibh nisl libero sed sit aenean. Suspendisse egestas erat vitae placerat egestas magna ipsum tortor et.",
    },
    path:
  ...
  },
  {
    name: "Meta",
    info: {
      description: "Meta es un departamento del centro de Colombia, que comprende el área desde los Andes al oeste, hasta las llanuras de Los Llanos. Su capital, Villavicencio, está rodeada de cerros y llanuras al noroeste. Es conocida por sus parques, el baile del joropo y el coleo. La catedral Nuestra Señora del Carmen, construida en el siglo XIX",
      hydrography: "hidrografia -Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec viverra integer tristique nibh nisl libero sed sit aenean. Suspendisse egestas erat vitae placerat egestas magna ipsum tortor et.",
      fauna: "fauna y flora - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec viverra integer tristique nibh nisl libero sed sit aenean. Suspendisse egestas erat vitae placerat egestas magna ipsum tortor et.",
    },
    path:
  ...
  },
  {
    name: "Amazonas",
    info: {
      description: "Amazonas es uno de los treinta y dos departamentos que, junto con Bogotá, Distrito Capital, forman la República de Colombia. Su capital es Leticia. Está ubicado en el extremo sur del país, en gran parte al sur de la línea ecuatorial, en la región Amazonia",
      hydrography: "hidrografia -Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec viverra integer tristique nibh nisl libero sed sit aenean. Suspendisse egestas erat vitae placerat egestas magna ipsum tortor et.",
      fauna: "fauna y flora - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec viverra integer tristique nibh nisl libero sed sit aenean. Suspendisse egestas erat vitae placerat egestas magna ipsum tortor et.",
    },
    path:
