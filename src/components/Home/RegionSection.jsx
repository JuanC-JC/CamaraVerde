      ...
      <div className="region__container">
        <div className="region__info">
          ...
          <div className="info__grahpicsItems">
            ...
            <svg onClick={setSelectInfo} data-typeInfo='history' className={`info__graphic ${selectedInfo === 'history' && 'info__graphic--selected'}`} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="25" cy="25" r="24" stroke="#2a5b4b" stroke-width="2"/>
              <path d="M15.4703 23.6667C14.5062 25.339 13.9991 27.2356 14 29.1659C14.0009 31.0962 14.5097 32.9923 15.4754 34.6637C16.4411 36.3351 17.8296 37.723 19.5015 38.6879C21.1733 39.6528 23.0697 40.1608 25 40.1608C26.9303 40.1608 28.8267 39.6528 30.4985 38.6879C32.1704 37.723 33.5589 36.3351 34.5246 34.6637C35.4903 32.9923 35.9991 31.0962 36 29.1659C36.0009 27.2356 35.4938 25.339 34.5297 23.6667L25.0018 9L15.4685 23.6667H15.4703Z" stroke="#205033" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>

            <svg onClick={setSelectInfo} data-typeInfo='food' className={`info__graphic ${selectedInfo === 'food' && 'info__graphic--selected'}`} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg onClick={setSelectInfo} data-typeInfo='general' className={`info__graphic ${selectedInfo === 'general' && 'info__graphic--selected'}`} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="25" cy="25" r="24" stroke="#2a5b4b" strokeWidth="2"/>
